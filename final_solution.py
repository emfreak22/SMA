...
n = 10
N = n  # Number of stocks to pick if 'long' condition is satisfied
        ...
        if len(portfolio) < N:
            ...
            for symbol in top_stocks:
                ...
                try:
                    ...
                    print(f"No data for {date}, {symbol}")
        ...
        for symbol in list(portfolio.keys()):
            try:
                ...
                if check_long_close_condition(stock_data):
                    ...
                    # filtered_data = [d for d in transaction_history
                    #                  if d['Stock'] == symbol and 'Sell Price' not in d]
                    # stock_history.update(sell_history)
                    # transaction_history.append(sell_history)
                    print(
